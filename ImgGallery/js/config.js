...
$(function() { h5u_parallelism.init({
	introDelay:			100,		// Delay (in ms) before showing the reel
	introSpeed:			250,		// Speed (in ms) at which to fade in reel
	thumbDelay:			900,		// Delay (in ms) before showing thumbnails
	thumbDelaySpread:	1200,		// Spread (in ms) to randomly stagger thumbnails (0 = don't stagger)
	thumbSpeed:			650,		// Speed (in ms) at which to fade in thumbnails
